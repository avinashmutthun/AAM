...
public class TC17_DeleteQualification {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 1; i <= ts; i++) {
			String Qualificationseducationtable = Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr[" + i + "]/td[4]"))
					.getText();
			if (Qualificationseducationtable.equals(QualIn)) {
				Driver.findElement(By.xpath("//html/body/div/div[2]/form/table/tbody/tr[" + i + "]/td[1]/input"))
						.click();
				Thread.sleep(2000);
			}
		}
		...
		String succesfullydeleted = Driver.findElement(By.xpath("//span[@class='success']")).getText();
		if (succesfullydeleted.equals("Successfully Deleted")) {
			System.out.println(succesfullydeleted);
			System.out.println("----------------------------------------------------");
		}
		Thread.sleep(1000);
