...
public class TC4_deleteEmployee {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 1; i <= ts; i++) {
			...
			if (id.contains(strEmpCode)) {
				...
				String succesfullydeleted = Driver.findElement(By.xpath("//span[@class='failure']")).getText();
				if (succesfullydeleted.equals("Successfully Deleted")) {
					System.out.println(strEmpCode);
					System.out.println("----------------------------------------------------");
					System.out.println(sFN + "  " + sLN);
					System.out.println("----------------------------------------------------");
					System.out.println("Given Empcode and EmpName is Successfully displayed and deleted");
					System.out.println("----------------------------------------------------");
				} else {
					break;
				}
