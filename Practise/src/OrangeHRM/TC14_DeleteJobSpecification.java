...
public class TC14_DeleteJobSpecification {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// ------------------------------------------------------------------------------------
				...
				for (int i = 1; i <= ts; i++) {
					String JobSpecificationsTable = Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr[" + i + "]/td[3]")).getText();
					
					if (JobSpecificationsTable.equals(DescName)) {
						System.out.println(JobSpecificationsTable);
						System.out.println("----------------------------------------------------");
