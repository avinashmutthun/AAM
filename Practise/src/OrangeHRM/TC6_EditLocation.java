...
public class TC6_EditLocation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 1; i <= ts; i++) {
			String CompanyInfoLoc = Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr[" + i + "]/td[3]"))
					.getText();
		...
		// --------------------------------------------------------------------------------------------------------------------------------
				...
				Driver.findElement(By.id("txtLocDescription")).sendKeys(Nm);
				Driver.findElement(By.id("editBtn")).click();
				Thread.sleep(2000);
			}
		}
