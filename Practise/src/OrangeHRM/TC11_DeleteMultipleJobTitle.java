...
public class TC11_DeleteMultipleJobTitle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// --------------------------------------------------------------------------------
		String AJTN = "QA" + d;
		String AJTD = "and will delete now";
		...
		for (int i = 1; i <= ts; i++) {
			String JobTitleName = Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr[" + i + "]/td[3]/a")).getText();

			if (JobTitleName.contains("QA")) {
		...
		alertd.accept();
		System.out.println("Multiple Input is marked and Deleted");
		System.out.println("----------------------------------------------------");
